...
namespace DentalBooking.Infrastructure.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Procedures",
                columns: new[] { "Id", "Code", "Duration", "Name", "Price" },
                values: new object[,]
                {
                    { 1, "A", new TimeSpan(0, 0, 30, 0, 0), "Procedure A", 50m },
                    { 2, "B", new TimeSpan(0, 0, 45, 0, 0), "Procedure B", 70m },
                    { 3, "C", new TimeSpan(0, 1, 0, 0, 0), "Procedure C", 100m },
                    { 4, "D", new TimeSpan(0, 0, 20, 0, 0), "Procedure D", 40m },
                    { 5, "E", new TimeSpan(0, 1, 30, 0, 0), "Procedure E", 150m }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NotificationLogs_BookingId_Type",
